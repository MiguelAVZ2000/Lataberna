      ...
      <div className="container mx-auto px-4 relative z-10 max-w-7xl">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative group">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-[#EE8600]/5 rounded-full blur-[80px] -z-10" />
                ...
                <CardContent className="p-8 space-y-8">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    {[
                      ...
                      <div key={stat.label} className="bg-white rounded-sm p-4 text-center border-2 border-border group-hover:border-[#EE8600]/40 transition-all shadow-sm hover:shadow-md">
                        ...
                        <div className="text-3xl font-heading font-black text-[#242528] mt-2 group-hover:text-[#EE8600] transition-colors">{stat.val}</div>
                      </div>
                    ))}
                  </div>
                </CardContent>
